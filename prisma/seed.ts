...
await prisma.product.createMany({
  data: [
    { order: 0, slug: "solar",   name: "Sistemas de Energia Solar",  color: "#095b66", lightColor: "#e8f7f9",
    ...
    { order: 1, slug: "ecoflow", name: "EcoFlow PowerOcean",          color: "#0a7a89", lightColor: "#e6f5f7", 
    ...
    { order: 2, slug: "quadros", name: "Quadros Elétricos BT",        color: "#064e58", lightColor: "#e5f4f6",
    ...
    { order: 3, slug: "ups",     name: "UPS & Estabilizadores",       color: "#095b66", lightColor: "#e8f7f9", 
    ...
    { order: 4, slug: "mt",      name: "Postos de Transformação",     color: "#0a7a89", lightColor: "#e6f5f7", 
    ...
    { order: 5, slug: "ve",      name: "Mobilidade Elétrica",         color: "#064e58", lightColor: "#e5f4f6",
