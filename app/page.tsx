...
// /* ─────────────────────────────────────────────
//    WORLD MAP — Mercator, Natural Earth simplified
// ───────────────────────────────────────────── */
// type PresencePoint = { name: string; lon: number; lat: number; main: boolean; detail: string };

// /** Convert lon/lat to x/y in a 1000×507 Mercator viewBox */
...
//       >
//         {/* Ocean background */}
//         <rect width="1000" height="507" fill="#dff0f3" rx="6"/>

//         {/* ── LAND MASSES (Natural Earth simplified, Mercator) ── */}

//         {/* North America */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M98,68 L112,62 L128,60 L148,64 L162,72 L172,84 L176,98
//           L170,112 L160,124 L148,134 L138,148 L130,160 L122,168
//           L112,165 L102,158 L94,145 L88,130 L86,114 L88,98 L92,84 Z
//           M86,98 L78,92 L66,89 L58,94 L56,106 L62,114 L74,111 L82,105 Z
//           M162,72 L172,64 L182,60 L194,64 L196,74 L188,82 L176,80 Z
//         "/>
//         {/* Alaska */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M58,72 L70,66 L80,68 L84,78 L78,86 L66,86 L58,80 Z
//         "/>
//         {/* Greenland */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M178,22 L196,16 L212,20 L218,32 L210,44 L194,48 L180,44 L174,34 Z
//         "/>
//         {/* Central America & Caribbean */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M138,168 L148,172 L154,182 L150,192 L140,196 L130,190 L126,180 Z
//         "/>
//         {/* Cuba */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M152,152 L164,148 L170,154 L166,160 L154,160 Z
//         "/>
//         {/* South America */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M148,196 L168,190 L190,194 L208,204 L218,218 L222,236
//           L218,258 L210,280 L198,302 L186,322 L174,340 L162,348
//           L150,344 L140,332 L132,312 L128,290 L128,268 L132,246
//           L138,226 L144,210 Z
//         "/>

//         {/* Iceland */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M388,52 L400,46 L412,50 L414,60 L404,66 L390,62 Z
//         "/>
//         {/* British Isles */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M426,78 L434,72 L440,78 L436,88 L428,88 Z
//           M420,68 L428,62 L432,70 L426,76 L420,72 Z
//         "/>
//         {/* Europe main */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M436,80 L454,74 L474,74 L492,80 L504,90 L506,104
//           L498,116 L484,122 L470,124 L456,120 L444,112 L436,100 Z
//           M474,74 L490,66 L508,68 L516,78 L510,88 L494,90 L480,84 Z
//           M456,120 L464,128 L460,140 L450,140 L446,130 Z
//           M484,122 L492,130 L488,142 L478,142 L476,132 Z
//           M492,80 L510,76 L520,84 L516,94 L504,96 Z
//         "/>
//         {/* Scandinavia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M468,46 L480,38 L492,40 L496,52 L488,62 L476,64 L466,58 Z
//           M492,40 L506,32 L518,36 L518,50 L508,58 L494,56 Z
//           M480,62 L486,70 L480,78 L472,76 L470,68 Z
//         "/>
//         {/* Iberian peninsula (Portugal/Spain) — highlighted */}
//         <path fill="#a8d5db" stroke="#7ab8bf" strokeWidth="1" d="
//           M430,110 L448,106 L460,110 L462,122 L456,132 L440,136 L428,130 L424,120 Z
//         "/>

//         {/* Africa — key continent */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M452,152 L472,146 L494,148 L512,158 L524,172 L528,190
//           L524,210 L518,230 L516,252 L520,272 L516,294 L506,314
//           L492,330 L476,340 L460,338 L446,326 L436,308 L430,288
//           L430,266 L432,244 L438,224 L440,204 L438,184 L440,166 L446,158 Z
//         "/>
//         {/* Western Africa coast / Gulf of Guinea bump */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M440,204 L428,208 L420,218 L420,228 L428,232 L440,228 Z
//         "/>
//         {/* Madagascar */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M532,272 L540,262 L548,266 L549,282 L542,294 L534,290 L530,280 Z
//         "/>
//         {/* Cape Verde Islands — highlighted */}
//         <path fill="#a8d5db" stroke="#7ab8bf" strokeWidth="1" d="
//           M395,212 L401,208 L405,214 L401,220 L395,218 Z
//         "/>
//         {/* São Tomé — highlighted */}
//         <path fill="#a8d5db" stroke="#7ab8bf" strokeWidth="1" d="
//           M477,253 L481,249 L484,254 L480,259 L476,257 Z
//         "/>

//         {/* Middle East / Arabian Peninsula */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M524,158 L546,150 L570,152 L585,164 L590,180 L582,198
//           L566,208 L548,212 L532,204 L522,190 L522,174 Z
//         "/>
//         {/* Turkey */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M504,118 L528,112 L550,114 L562,124 L558,136 L540,142 L518,140 L504,132 Z
//         "/>

//         {/* Russia / Central Asia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M506,60 L560,50 L620,46 L680,48 L730,54 L762,62 L774,76
//           L766,90 L748,100 L720,106 L688,108 L656,106 L624,104
//           L596,108 L570,114 L550,114 L528,112 L510,104 L504,90 Z
//         "/>
//         {/* Kazakhstan / Central Asia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M560,108 L596,104 L628,108 L648,118 L648,132 L632,142
//           L608,146 L582,142 L562,134 L556,120 Z
//         "/>
//         {/* China / East Asia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M648,100 L688,96 L730,98 L762,106 L772,120 L764,136
//           L748,148 L724,154 L698,152 L674,146 L652,138 L640,126 L640,112 Z
//         "/>
//         {/* Indian Subcontinent */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M585,164 L606,156 L626,160 L638,174 L640,192 L632,210
//           L616,224 L598,228 L582,220 L572,206 L570,188 L576,172 Z
//         "/>
//         {/* SE Asia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M672,152 L696,146 L716,150 L728,164 L722,180 L704,188 L686,184
//           L672,172 L666,160 Z
//           M724,158 L740,150 L754,156 L756,172 L742,180 L726,174 Z
//         "/>
//         {/* Korean peninsula */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M762,106 L774,100 L782,106 L778,120 L768,124 L760,118 Z
//         "/>
//         {/* Japan */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M786,104 L796,98 L804,104 L800,116 L790,118 Z
//           M800,116 L810,110 L818,118 L812,130 L802,130 Z
//         "/>
//         {/* Australia */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M742,308 L770,296 L802,298 L828,312 L840,332 L836,356
//           L820,372 L796,378 L770,372 L748,358 L738,338 L736,318 Z
//         "/>
//         {/* New Zealand */}
//         <path fill="#b6d9de" stroke="#8abfc6" strokeWidth="0.8" d="
//           M862,360 L870,352 L876,360 L870,372 L862,370 Z
//           M866,372 L874,364 L880,372 L876,384 L866,380 Z
//         "/>

//         {/* ── CONNECTING LINES (main offices) ── */}
//         {dots.filter(p => p.main).flatMap((p, i) =>
//           dots.filter((q, j) => q.main && j > i).map((q, j) => (
//             <line key={`line-${i}-${j}`}
//               x1={p.cx} y1={p.cy} x2={q.cx} y2={q.cy}
//               stroke="#095b66" strokeWidth="1.2" strokeDasharray="5 5" opacity="0.55"
//             />
//           ))
//         )}
...
//             {p.main && (
//               <>
//                 <circle cx={p.cx} cy={p.cy} r="14" fill="#095b66" opacity="0">
...
//                 </circle>
//                 <circle cx={p.cx} cy={p.cy} r="8" fill="#095b66" opacity="0.18"/>
//               </>
//             )}
//             <circle
//               cx={p.cx} cy={p.cy}
//               r={activePoint === i ? 8 : 5.5}
...
//         const pctY = (d.cy / 507) * 100;
//         return (
//           <div style={{
//             position: "absolute",
//             left: `${pctX}%`,
//             top: `${pctY}%`,
//             transform: `translate(${pctX > 65 ? "-105%" : "12px"}, ${pctY > 55 ? "-115%" : "12px"})`,
//             background: "#fff",
...
//             pointerEvents: "none",
//           }}>
//             <div style={{ fontSize: 12, fontWeight: 800, color: "#095b66", marginBottom: 5 }}>
//               {d.name}
//             </div>
//             <div style={{ fontSize: 11.5, color: "#4a7275", lineHeight: 1.65, whiteSpace: "pre-line" }}>
//               {d.detail}
//             </div>
//           </div>
//         );
...
//                 </h2>
//               </div>
//               <Link href="/sobre" style={{ fontSize: 12, fontWeight: 700, color: "#095b66", letterSpacing: ".06em", textTransform: "uppercase", borderBottom: "2px solid #095b66", paddingBottom: 2 }}>
//                 Ver todos →
//               </Link>
//             </div>
//           </Reveal>
