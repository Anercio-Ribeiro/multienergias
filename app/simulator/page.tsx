...
//       {loaderVis && (
//         <div style={{
//           position:"fixed", inset:0, zIndex:9999, background:"#095b66",
//           display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:28,
//           transition:"opacity .48s ease, transform .48s ease",
//           opacity:loaderFade ? 0 : 1, transform:loaderFade ? "scale(1.02)" : "none",
//           pointerEvents:loaderFade ? "none" : "auto",
//         }}>
//           <div style={{ display:"flex", alignItems:"center", gap:10, animation:"ml-pulse 1.6s ease infinite" }}>
...
//               </svg>
//             </div>
//             <span style={{ fontFamily:"'Montserrat',sans-serif", fontWeight:900, fontSize:22, color:"#fff" }}>
//               Multi<span style={{ color:"rgba(255,255,255,.45)" }}>energia</span>
//             </span>
//           </div>
//           <div style={{ width:160, height:2, borderRadius:99, background:"rgba(255,255,255,.15)", overflow:"hidden" }}>
//             <div style={{ height:"100%", width:"100%", background:"#fff", borderRadius:99, transformOrigin:"left", animation:"ml-bar .9s cubic-bezier(.4,0,.2,1) forwards" }}/>
//           </div>
//           <div style={{ display:"flex", gap:6 }}>
//             {[0, 1, 2].map(i => (
//               <div key={i} style={{ width:5, height:5, borderRadius:"50%", background:"rgba(255,255,255,.6)", animation:`ml-pulse 1.2s ${i * 0.18}s ease infinite` }}/>
//             ))}
//           </div>
//         </div>
//       )}
...
//         @keyframes ml-bar { 0%{transform:scaleX(0)} 60%{transform:scaleX(.75)} 100%{transform:scaleX(1)} }
//         @keyframes ml-pulse { 0%,100%{opacity:1} 50%{opacity:.5} }
//         @keyframes fadeUp { from{opacity:0;transform:translateY(14px);}to{opacity:1;transform:none;} }
//         .fade-up { animation: fadeUp .4s ease both; }
